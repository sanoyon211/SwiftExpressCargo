        ...
        <div className="container relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="reveal-left">
              ...
              <h2 className="font-bold text-3xl md:text-5xl text-slate-900 mb-6">Our Story</h2>
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="bg-slate-50 rounded-[20px] p-6 text-center shadow-sm border border-slate-100 hover:border-teal-100 hover:shadow-md transition-all">
                  <div className="font-bold text-3xl text-slate-900 mb-2">5+</div>
                  <div className="text-teal-600 font-medium text-xs uppercase tracking-wider">Years Exp</div>
                </div>
                <div className="bg-slate-50 rounded-[20px] p-6 text-center shadow-sm border border-slate-100 hover:border-teal-100 hover:shadow-md transition-all">
                  <div className="font-bold text-3xl text-slate-900 mb-2">50k+</div>
                  <div className="text-teal-600 font-medium text-xs uppercase tracking-wider">Delivered</div>
                </div>
                <div className="bg-slate-50 rounded-[20px] p-6 text-center shadow-sm border border-slate-100 hover:border-teal-100 hover:shadow-md transition-all">
                  <div className="font-bold text-3xl text-slate-900 mb-2">15k+</div>
            ...
            <div className="reveal-right relative">
              ...
              <div className="absolute -bottom-8 -left-8 bg-white rounded-[24px] shadow-xl p-6 border border-slate-100 z-20 flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-slate-500 font-medium">Best Cargo 2024</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-slate-50">
        <div className="container">
          <div className="text-center mb-16 reveal">
            ...
            <h2 className="font-bold text-3xl md:text-5xl text-slate-900 mb-6">Why Choose Us</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 stagger reveal">
            <div className="card-hover bg-white rounded-[24px] border border-slate-100 p-8 flex flex-col sm:flex-row items-start gap-6 shadow-sm">
              ...
              <div>
                <h4 className="font-bold text-xl text-slate-900 mb-3">Package Consolidation</h4>
                <p className="text-slate-500 leading-relaxed">Combine multiple packages into one shipment. Save up to 40% on shipping costs by seamlessly consolidating orders from different US retailers.</p>
              </div>
            </div>
            ...
            <div className="card-hover bg-white rounded-[24px] border border-slate-100 p-8 flex flex-col sm:flex-row items-start gap-6 shadow-sm">
              ...
              <div>
                <h4 className="font-bold text-xl text-slate-900 mb-3">Security & Reliability</h4>
                <p className="text-slate-500 leading-relaxed">Every package is fully insured during transit. Our secure warehousing and meticulous handling ensure your items arrive safely.</p>
              </div>
            </div>
            ...
            <div className="card-hover bg-white rounded-[24px] border border-slate-100 p-8 flex flex-col sm:flex-row items-start gap-6 shadow-sm">
              ...
              <div>
                <h4 className="font-bold text-xl text-slate-900 mb-3">Real-time Tracking</h4>
                <p className="text-slate-500 leading-relaxed">Track your shipment accurately at every step of the journey. Receive automatic SMS and email notifications for every vital status update.</p>
              </div>
            </div>
            ...
            <div className="card-hover bg-white rounded-[24px] border border-slate-100 p-8 flex flex-col sm:flex-row items-start gap-6 shadow-sm">
              ...
              <div>
                <h4 className="font-bold text-xl text-slate-900 mb-3">24/7 Customer Support</h4>
                <p className="text-slate-500 leading-relaxed">Our dedicated, global support team is available around the clock via phone, email, and WhatsApp to assist with any inquiries.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="container">
          <div className="text-center mb-16 reveal">
            ...
            <h2 className="font-bold text-3xl md:text-5xl text-slate-900 mb-6">Meet Our Team</h2>
            <p className="text-slate-500 text-lg max-w-2xl mx-auto">The dedicated professionals who make it all happen.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 stagger reveal">
            {[
              ...
              <div key={index} className="card-hover bg-slate-50 rounded-[24px] shadow-sm border border-slate-100 overflow-hidden text-center group">
