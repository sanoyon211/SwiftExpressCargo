...
export default function MainContent() {
  return (
    <>
      ...
      <header className="relative w-full min-h-[400px] md:min-h-[500px] flex items-center justify-center overflow-hidden bg-slate-900 dark:border-b dark:border-slate-800">
        ...
        <div className="container relative z-20 pt-32 pb-20 text-center">
          ...
          <h1 className="hero-text text-3xl md:text-2xl md:text-3xl md:text-7xl font-semibold tracking-tight text-white mb-6">
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-indigo-500">Us</span>
          </h1>
        ...
        <div className="container relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="reveal-left">
              <span className="text-indigo-700 font-medium tracking-wider uppercase text-sm mb-3 block">Our Journey</span>
              <h2 className="font-semibold text-3xl md:text-3xl md:text-2xl md:text-3xl text-slate-900 dark:text-slate-50 mb-6 tracking-tight">Our Story</h2>
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="bg-slate-50 dark:bg-slate-900 rounded-[20px] p-6 text-center shadow-sm border border-slate-100 dark:border-white/5 hover:border-indigo-200 hover:shadow-md transition-all">
                  <div className="font-semibold text-3xl text-slate-900 dark:text-slate-50 mb-2">5+</div>
                  <div className="text-indigo-700 font-medium text-xs uppercase tracking-wider">Years Exp</div>
                </div>
                <div className="bg-slate-50 dark:bg-slate-900 rounded-[20px] p-6 text-center shadow-sm border border-slate-100 dark:border-white/5 hover:border-indigo-200 hover:shadow-md transition-all">
                  <div className="font-semibold text-3xl text-slate-900 dark:text-slate-50 mb-2">50k+</div>
                  <div className="text-indigo-700 font-medium text-xs uppercase tracking-wider">Delivered</div>
                </div>
                <div className="bg-slate-50 dark:bg-slate-900 rounded-[20px] p-6 text-center shadow-sm border border-slate-100 dark:border-white/5 hover:border-indigo-200 hover:shadow-md transition-all">
                  <div className="font-semibold text-3xl text-slate-900 dark:text-slate-50 mb-2">15k+</div>
                  <div className="text-indigo-700 font-medium text-xs uppercase tracking-wider">Clients</div>
                </div>
              </div>
            </div>
            
            <div className="reveal-right relative">
              <div className="rounded-[32px] overflow-hidden shadow-md h-[500px] relative">
                <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent z-10"></div>
                <img src="/assets/image (4).png" alt="Our Team" className="w-full h-full object-cover" />
              </div>
              <div className="absolute -bottom-8 -left-8 bg-white dark:bg-slate-800 rounded-[24px] shadow-sm p-6 border border-slate-100 dark:border-white/5 z-20 flex items-center gap-4 dark:border dark:border-white/5">
                <div className="w-14 h-14 bg-indigo-600 rounded-[24px] flex items-center justify-center shadow-sm shadow-indigo-600/30">
                  <i className="fas fa-award text-white text-2xl"></i>
                </div>
                <div>
                  <div className="font-semibold text-slate-900 dark:text-slate-50 text-lg">Award Winning</div>
      ...
      {/* WHY CHOOSE US */}
      <section className="py-10 md:py-8 md:py-16 px-4 md:py-8 md:py-16 px-4 bg-slate-50 dark:bg-slate-900">
        <div className="container">
          <div className="text-center mb-16 reveal">
            <span className="text-indigo-700 font-medium tracking-wider uppercase text-sm mb-3 block">Our Advantage</span>
            <h2 className="font-semibold text-3xl md:text-3xl md:text-2xl md:text-3xl text-slate-900 dark:text-slate-50 mb-6 tracking-tight">Why Choose Us</h2>
            <p className="text-slate-500 dark:text-slate-400 text-lg max-w-2xl mx-auto">
              We offer unmatched shipping services with transparency, absolute reliability, and premium care.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 stagger reveal">
            <div className="transition-all duration-300 hover:-translate-y-1.5 hover:shadow-sm hover:border-indigo-600/10 dark:hover:shadow-md bg-white dark:bg-slate-800 rounded-[24px] border border-slate-100 dark:border-white/5 p-5 md:p-4 md:p-8 flex flex-col sm:flex-row items-start gap-6 shadow-sm dark:border dark:border-white/5">
              <div className="w-16 h-16 bg-indigo-50 rounded-[20px] flex items-center justify-center flex-shrink-0">
                <i className="fas fa-box-open text-indigo-700 text-2xl"></i>
              </div>
              <div>
                <h4 className="font-semibold text-xl text-slate-900 dark:text-slate-50 mb-3 tracking-tight">Package Consolidation</h4>
            ...
            <div className="transition-all duration-300 hover:-translate-y-1.5 hover:shadow-sm hover:border-indigo-600/10 dark:hover:shadow-md bg-white dark:bg-slate-800 rounded-[24px] border border-slate-100 dark:border-white/5 p-5 md:p-4 md:p-8 flex flex-col sm:flex-row items-start gap-6 shadow-sm dark:border dark:border-white/5">
              ...
              <div>
                <h4 className="font-semibold text-xl text-slate-900 dark:text-slate-50 mb-3 tracking-tight">Security & Reliability</h4>
            ...
            <div className="transition-all duration-300 hover:-translate-y-1.5 hover:shadow-sm hover:border-indigo-600/10 dark:hover:shadow-md bg-white dark:bg-slate-800 rounded-[24px] border border-slate-100 dark:border-white/5 p-5 md:p-4 md:p-8 flex flex-col sm:flex-row items-start gap-6 shadow-sm dark:border dark:border-white/5">
              <div className="w-16 h-16 bg-indigo-50 rounded-[20px] flex items-center justify-center flex-shrink-0">
                <i className="fas fa-map-marker-alt text-indigo-700 text-2xl"></i>
              </div>
              <div>
                <h4 className="font-semibold text-xl text-slate-900 dark:text-slate-50 mb-3 tracking-tight">Real-time Tracking</h4>
            ...
            <div className="transition-all duration-300 hover:-translate-y-1.5 hover:shadow-sm hover:border-indigo-600/10 dark:hover:shadow-md bg-white dark:bg-slate-800 rounded-[24px] border border-slate-100 dark:border-white/5 p-5 md:p-4 md:p-8 flex flex-col sm:flex-row items-start gap-6 shadow-sm dark:border dark:border-white/5">
              ...
              <div>
                <h4 className="font-semibold text-xl text-slate-900 dark:text-slate-50 mb-3 tracking-tight">24/7 Customer Support</h4>
      ...
      <section className="py-10 md:py-8 md:py-16 px-4 md:py-8 md:py-16 px-4 bg-white dark:bg-slate-900">
        <div className="container">
          <div className="text-center mb-16 reveal">
            <span className="text-indigo-700 font-medium tracking-wider uppercase text-sm mb-3 block">Leadership</span>
            <h2 className="font-semibold text-3xl md:text-3xl md:text-2xl md:text-3xl text-slate-900 dark:text-slate-50 mb-6 tracking-tight">Meet Our Team</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 stagger reveal">
            {[
              ...
              <div key={index} className="transition-all duration-300 hover:-translate-y-1.5 hover:shadow-sm hover:border-indigo-600/10 dark:hover:shadow-md bg-slate-50 dark:bg-slate-800 rounded-[24px] shadow-sm border border-slate-100 dark:border-white/5 overflow-hidden text-center group">
                <div className="h-56 bg-slate-200 flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="w-full h-full bg-slate-300 flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
                    <i className="fas fa-user text-slate-400 text-3xl md:text-2xl md:text-3xl"></i>
                  </div>
                </div>
                <div className="p-6 relative z-20 bg-white dark:bg-slate-800">
                  <h4 className="font-semibold text-slate-900 dark:text-slate-50 text-xl mb-1 tracking-tight">{member.name}</h4>
                  <p className="text-indigo-700 font-medium text-sm mb-3">{member.role}</p>
