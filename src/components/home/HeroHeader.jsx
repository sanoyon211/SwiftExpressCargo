      ...
      <div className="container relative z-20 pt-24 pb-24 md:pt-32 md:pb-32 px-4 flex flex-col items-center text-center">
        <StaggerContainer>
          <div className="hero-text">
            <StaggerItem>
              <span className="inline-flex items-center gap-2 bg-white/10 dark:bg-slate-800/10 backdrop-blur-md text-teal-300 text-sm font-medium px-5 py-2 rounded-full mb-8 border border-white/10 shadow-[0_0_20px_rgba(13,148,136,0.3)]">
        ...
        <div className="flex gap-3 mt-auto absolute bottom-16">
          {bgImages.map((_, index) => (
            <button
              ...
              className={`h-1.5 rounded-full transition-all duration-500 ${currentSlide === index ? 'w-8 bg-teal-500' : 'w-2 bg-white/30 dark:bg-slate-800/30 hover:bg-white/50 dark:bg-slate-800/50'}`}
