  ...
  return (
    <section className="py-24 bg-slate-50">
      <div className="container">
        <div className="bg-slate-900 rounded-[32px] p-10 md:p-16 reveal relative overflow-hidden shadow-2xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/10 rounded-[24px] p-8 shadow-2xl">
              <div className="mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <input type="text" id="trackInput2" placeholder="e.g. SEC-2025-001234"
                    className="flex-1 bg-white/5 text-white placeholder-slate-400 border border-white/20 rounded-xl px-5 py-4 focus:outline-none focus:border-teal-400 focus:bg-white/10 transition-all text-base" />
                  <Link href="/tracking">
