  ...
  <div className="container">
    <div className="flex justify-between items-start mb-10 reveal">
      <div>
        ...
        <h2 className="font-bold text-2xl md:text-[36px] text-slate-900">Our Blog</h2>
        <p className="text-slate-500 mt-2">Tips, guides and shipping news</p>
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 stagger reveal">
      <article className="card-hover bg-white rounded-[24px] shadow-sm overflow-hidden border border-slate-200">
        ...
        <div className="p-6">
          ...
          <h3 className="font-bold text-lg text-slate-900 mb-2">How to Package Your Items for International Shipping</h3>
          <p className="text-slate-500 text-sm leading-relaxed mb-4">Learn the best practices for packaging your items to ensure they arrive safely.</p>
      ...
      <article className="card-hover bg-white rounded-[24px] shadow-sm overflow-hidden border border-slate-200">
        ...
        <div className="p-6">
          ...
          <h3 className="font-bold text-lg text-slate-900 mb-2">Top 5 Ways to Save on Shipping Costs from USA</h3>
          <p className="text-slate-500 text-sm leading-relaxed mb-4">Discover smart strategies to reduce your international shipping expenses significantly.</p>
          <a href="/read-more" className="inline-flex items-center gap-2 text-teal-500 font-semibold text-sm hover:gap-3 transition-all">Read More <i className="fas fa-arrow-right text-xs"></i></a>
        </div>
      </article>
      <article className="card-hover bg-white rounded-[24px] shadow-sm overflow-hidden border border-slate-200">
        ...
        <div className="p-6">
          ...
          <h3 className="font-bold text-lg text-slate-900 mb-2">Understanding Customs & Duties for Bangladesh</h3>
          <p className="text-slate-500 text-sm leading-relaxed mb-4">A complete guide to navigating customs procedures for your international shipments.</p>
          <a href="/read-more" className="inline-flex items-center gap-2 text-teal-500 font-semibold text-sm hover:gap-3 transition-all">Read More <i className="fas fa-arrow-right text-xs"></i></a>
        </div>
      </article>
    </div>
