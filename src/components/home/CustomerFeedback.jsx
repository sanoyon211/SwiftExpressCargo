    ...
    <section className="py-24 bg-slate-50 dark:bg-slate-900">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 stagger reveal">
          <div className="card-hover bg-white dark:bg-slate-800 rounded-[32px] p-8 shadow-sm dark:border dark:border-slate-700 dark:hover:border-slate-600 transition-colors dark:border dark:border-slate-700">
