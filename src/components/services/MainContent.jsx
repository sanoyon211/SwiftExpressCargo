      ...
      <section className="py-10 md:py-16 px-4 md:py-24 px-4 bg-slate-50 dark:bg-slate-900 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 stagger reveal">
            {/* US Shipping */}
            <div className="transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-teal-500/10 dark:hover:shadow-2xl bg-white dark:bg-slate-800 rounded-[32px] border border-slate-100 dark:border-slate-700 p-5 md:p-8 flex flex-col items-center text-center gap-6 shadow-sm dark:border dark:border-slate-700">
            ...
            <div className="bg-slate-900 rounded-[32px] p-5 md:p-8 flex flex-col items-center text-center gap-6 shadow-2xl scale-105 relative z-10 transform transition-transform hover:-translate-y-2">
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 stagger reveal">
            {[
              ...
              <div key={index} className="transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-teal-500/10 dark:hover:shadow-2xl bg-slate-50 dark:bg-slate-800 rounded-[24px] p-5 md:p-8 border border-slate-100 dark:border-slate-700 flex gap-5 items-start transition-all">
