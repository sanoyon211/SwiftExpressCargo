  ...
  return (
    <>
      ...
      <div className="container">
        ...
        >
          <div
            className="ben-card bg-white rounded-[24px] border border-slate-200 p-6 flex flex-col items-center text-center gap-4 shadow-sm"
          >
            <div
            ...
            <h4 className="font-semibold text-slate-900">Package Consolidation</h4>
          ...
          >
            ...
            <h4 className="font-semibold text-slate-900">Security & Reliability</h4>
            <p className="text-slate-500 text-sm leading-relaxed">
